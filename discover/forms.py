...
class CommentForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "body": forms.Textarea(
                attrs={"placeholder": "Enter your comment here...", "required": True}
            ),
        }
...
class PostForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "title": forms.TextInput(
                attrs={"placeholder": "Enter the title of your post", "required": True}
            ),
            "slug": forms.TextInput(
                attrs={
                    "placeholder": "Enter a unique URL-friendly identifier",
                    "required": True,
                }
            ),
            ...
            "budget": forms.NumberInput(
                attrs={
                    "placeholder": "Enter the budget for this place",
                    "required": True,
                }
            ),
            "currency": forms.Select(attrs={"required": True}),
            "location": forms.TextInput(
                attrs={"placeholder": "Enter the location", "required": True}
            ),
            "latitude": forms.NumberInput(
                attrs={"placeholder": "Enter the latitude", "required": True}
            ),
            "longitude": forms.NumberInput(
                attrs={"placeholder": "Enter the longitude", "required": True}
            ),
            "nights": forms.NumberInput(
                attrs={"placeholder": "Enter the number of nights"}
            ),
            "people": forms.NumberInput(
                attrs={"placeholder": "Enter the number of people"}
            ),
        }
    ...
    def clean_title(self):
        ...
        if not all(x.isalpha() or x.isspace() for x in title):
            raise forms.ValidationError("The title must contain words and not numbers.")
        return title
    ...
    def clean_latitude(self):
        ...
        try:
            ...
            raise forms.ValidationError("The latitude must be a numeric value.")
        return latitude
    ...
    def clean_longitude(self):
        ...
        try:
            ...
            raise forms.ValidationError("The longitude must be a numeric value.")
        return longitude
